/**
 * Default Example workspace scripts (same content as Data/example/flow_and_control_demo/).
 * Bundled so guest mode does not depend on /api/v1/exampleScript.
 */

export const EXAMPLE_LFR_SCRIPT = `// Example: Flow + Control.
...
export const EXAMPLE_MINT_SCRIPT = `DEVICE flow_and_control_demo
