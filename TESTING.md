...
5. **Component Library** — Channel DIY **CHANNEL** vs **ROUNDED CHANNEL**; mux **Super_Mux_8** DIY **`leafPitch`** / **`valveWidth`** (μm; not `spacing`/`width`); open mux in 3DuF on **80 000²** board; DIY mixer `edgeBend*`.
