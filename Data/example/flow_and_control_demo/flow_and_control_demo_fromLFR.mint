...
CHANNEL channel_1 from mixer_1 2 to port_1 1 RoundedChannel=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_2 from port_2 1 to mixer_1 1 RoundedChannel=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_3 from port_3 1 to mixer_1 1 RoundedChannel=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_4 from port_4 1 to port_1 1 RoundedChannel=1 connectionSpacing=1000 channelWidth=800  ;
...
CHANNEL Ctrlchannel_0 from Cport_0 1 to valve_0 1 RoundedChannel=1 channelWidth=600 connectionSpacing=1000  ;
CHANNEL Ctrlchannel_1 from Cport_1 1 to valve_1 1 RoundedChannel=1 channelWidth=600 connectionSpacing=1000  ;
