...
CHANNEL CHANNEL_1 from Port_1 1 to Port_2 1 connectionSpacing=1600 channelWidth=600 RoundedChannel=0 height=250 ;
END LAYER
...
CHANNEL CHANNEL_2 from Port_3 1 to Valve3D_control_3 1 connectionSpacing=1600 channelWidth=600 RoundedChannel=0 height=250 ;
CHANNEL CHANNEL_3 from Port_5 1 to Valve3D_control_1 1 connectionSpacing=1600 channelWidth=600 RoundedChannel=1 height=250 ;
END LAYER
